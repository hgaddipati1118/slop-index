...
META = {
    ...
    "gpt-6-astra-pro":         ("GPT-6 Astra Pro", "OpenAI"),
    "hy4-preview":             ("Hunyuan 4 Preview", "Tencent"),
    "inkling-small":           ("Inkling Small", "Thinking Machines"),
    "seed-2.1-turbo":          ("Seed 2.1 Turbo", "ByteDance"),
